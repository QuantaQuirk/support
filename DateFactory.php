 ...
 *
 * @method \QuantaQuirk\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \QuantaQuirk\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \QuantaQuirk\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \QuantaQuirk\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \QuantaQuirk\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \QuantaQuirk\Support\Carbon fromSerialized($value)
 ...
 * @method \QuantaQuirk\Support\Carbon|null getTestNow()
 ...
 * @method \QuantaQuirk\Support\Carbon instance($date)
 ...
 * @method \QuantaQuirk\Support\Carbon|null make($var)
 * @method \QuantaQuirk\Support\Carbon maxValue()
 * @method \QuantaQuirk\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \QuantaQuirk\Support\Carbon now($tz = null)
 * @method \QuantaQuirk\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \QuantaQuirk\Support\Carbon today($tz = null)
 * @method \QuantaQuirk\Support\Carbon tomorrow($tz = null)
 ...
 * @method \QuantaQuirk\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
