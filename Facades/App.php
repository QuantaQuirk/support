 ...
 * @method static \QuantaQuirk\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \QuantaQuirk\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \QuantaQuirk\Foundation\Application useEnvironmentPath(string $path)
 * @method static \QuantaQuirk\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \QuantaQuirk\Support\ServiceProvider register(\QuantaQuirk\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \QuantaQuirk\Support\ServiceProvider|null getProvider(\QuantaQuirk\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\QuantaQuirk\Support\ServiceProvider|string $provider)
 * @method static \QuantaQuirk\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \QuantaQuirk\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \QuantaQuirk\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \QuantaQuirk\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \QuantaQuirk\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \QuantaQuirk\Foundation\Application getInstance()
 * @method static \QuantaQuirk\Contracts\Container\Container|\QuantaQuirk\Foundation\Application setInstance(\QuantaQuirk\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \QuantaQuirk\Foundation\Application
 */
