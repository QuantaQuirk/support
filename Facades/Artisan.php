 ...
 * @method static \QuantaQuirk\Support\Carbon|null commandStartedAt()
 * @method static \QuantaQuirk\Foundation\Console\ClosureCommand command(string $signature, \Closure $callback)
 ...
 * @method static \QuantaQuirk\Foundation\Bus\PendingDispatch queue(string $command, array $parameters = [])
 * @method static array all()
 * @method static string output()
 * @method static void bootstrap()
 * @method static void bootstrapWithoutBootingProviders()
 * @method static void setArtisan(\QuantaQuirk\Console\Application|null $artisan)
 *
 * @see \QuantaQuirk\Foundation\Console\Kernel
 */
