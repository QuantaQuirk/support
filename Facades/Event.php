 ...
 * @method static \QuantaQuirk\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static array getRawListeners()
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static \QuantaQuirk\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \QuantaQuirk\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 *
 * @see \QuantaQuirk\Events\Dispatcher
 * @see \QuantaQuirk\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \QuantaQuirk\Support\Testing\Fakes\EventFake
     */
