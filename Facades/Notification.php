...
/**
 * @method static void send(\QuantaQuirk\Support\Collection|array|mixed $notifiables, mixed $notification)
 * @method static void sendNow(\QuantaQuirk\Support\Collection|array|mixed $notifiables, mixed $notification, array|null $channels = null)
 * @method static mixed channel(string|null $name = null)
 * @method static string getDefaultDriver()
 * @method static string deliversVia()
 * @method static void deliverVia(string $channel)
 * @method static \QuantaQuirk\Notifications\ChannelManager locale(string $locale)
 * @method static mixed driver(string|null $driver = null)
 * @method static \QuantaQuirk\Notifications\ChannelManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \QuantaQuirk\Contracts\Container\Container getContainer()
 * @method static \QuantaQuirk\Notifications\ChannelManager setContainer(\QuantaQuirk\Contracts\Container\Container $container)
 * @method static \QuantaQuirk\Notifications\ChannelManager forgetDrivers()
 ...
 * @method static \QuantaQuirk\Support\Collection sent(mixed $notifiable, string $notification, callable|null $callback = null)
 ...
 *
 * @see \QuantaQuirk\Notifications\ChannelManager
 * @see \QuantaQuirk\Support\Testing\Fakes\NotificationFake
 */
class Notification extends Facade
{
     ...
     *
     * @return \QuantaQuirk\Support\Testing\Fakes\NotificationFake
     */
     ...
     * @param  mixed  $route
     * @return \QuantaQuirk\Notifications\AnonymousNotifiable
     */
