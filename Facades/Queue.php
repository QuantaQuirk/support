 ...
 * @method static \QuantaQuirk\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \QuantaQuirk\Queue\QueueManager setApplication(\QuantaQuirk\Contracts\Foundation\Application $app)
 ...
 * @method static \QuantaQuirk\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \QuantaQuirk\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \QuantaQuirk\Container\Container getContainer()
 * @method static void setContainer(\QuantaQuirk\Container\Container $container)
 * @method static \QuantaQuirk\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \QuantaQuirk\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static bool hasPushed(string $job)
 * @method static bool shouldFakeJob(object $job)
 * @method static array pushedJobs()
 * @method static \QuantaQuirk\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \QuantaQuirk\Queue\QueueManager
 * @see \QuantaQuirk\Queue\Queue
 * @see \QuantaQuirk\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \QuantaQuirk\Support\Testing\Fakes\QueueFake
     */
