...
/**
 * @method static \QuantaQuirk\Cache\RateLimiter for(string $name, \Closure $callback)
 ...
 *
 * @see \QuantaQuirk\Cache\RateLimiter
 */
class RateLimiter extends Facade
{
    ...
    {
        return \QuantaQuirk\Cache\RateLimiter::class;
    }
}
