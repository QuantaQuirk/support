...
/**
 * @method static \QuantaQuirk\Http\Request capture()
 * @method static \QuantaQuirk\Http\Request instance()
 ...
 * @method static \QuantaQuirk\Http\Request merge(array $input)
 * @method static \QuantaQuirk\Http\Request mergeIfMissing(array $input)
 * @method static \QuantaQuirk\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\InputBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \QuantaQuirk\Http\Request createFrom(\QuantaQuirk\Http\Request $from, \QuantaQuirk\Http\Request|null $to = null)
 * @method static \QuantaQuirk\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \QuantaQuirk\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \QuantaQuirk\Contracts\Session\Session session()
 * @method static void setQuantaQuirkSession(\QuantaQuirk\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \QuantaQuirk\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \QuantaQuirk\Http\Request setJson(\Symfony\Component\HttpFoundation\InputBag $json)
 * @method static \Closure getUserResolver()
 * @method static \QuantaQuirk\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \QuantaQuirk\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static \QuantaQuirk\Http\Request createFromGlobals()
 * @method static \QuantaQuirk\Http\Request create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], string|resource|null $content = null)
 ...
 * @method static string|array|null old(string|null $key = null, \QuantaQuirk\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \QuantaQuirk\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \QuantaQuirk\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \QuantaQuirk\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static array keys()
 * @method static array all(array|mixed|null $keys = null)
 * @method static mixed input(string|null $key = null, mixed $default = null)
 * @method static \QuantaQuirk\Support\Stringable str(string $key, mixed $default = null)
 * @method static \QuantaQuirk\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \QuantaQuirk\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \QuantaQuirk\Support\Collection collect(array|string|null $key = null)
 ...
 * @method static \QuantaQuirk\Http\UploadedFile|\QuantaQuirk\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static never dd(mixed ...$keys)
 * @method static \QuantaQuirk\Http\Request dump(mixed $keys = [])
