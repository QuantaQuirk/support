 ...
 * @method static \QuantaQuirk\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \QuantaQuirk\Contracts\Container\Container getContainer()
 * @method static \QuantaQuirk\Session\SessionManager setContainer(\QuantaQuirk\Contracts\Container\Container $container)
 * @method static \QuantaQuirk\Session\SessionManager forgetDrivers()
 ...
 * @method static void setRequestOnHandler(\QuantaQuirk\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \QuantaQuirk\Session\SessionManager
 */
